...
if __name__ == "__main__":
    ...
    from_date = to_date - datetime.timedelta(days=730)  # 3 months
    ...
    if df is not None:
        ...
        df_prepared.to_csv("data/niftybees_zerodha_prepared_2year.csv", index=False)
        print("✅ Data saved to data/niftybees_zerodha_prepared_2year.csv")
    else:
